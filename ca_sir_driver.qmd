...
## Run SIR Model in Pygame

## The repository structure:

# A functions folder containing python scripts: init.py, draw.py, update.py, and mouse.py. 
# A .qmd file containing this descriptiuon of the repository and a python driver code snippet. 

# Link to Github: https://github.com/bwilcens/CA_SIR_1600
